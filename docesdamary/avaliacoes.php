        ...
        <div class="row justify-content-center">
            <div class="col-lg-10">
                ...
                <div class="text-center mb-4">
                    <a href="create.php" class="btn btn-primary custom-btn-cta">Realizar nova avaliação</a>
                </div>
...
?>
<a href="edita.php?id=<?php echo $a['id']; ?>" class="btn btn-sm btn-warning me-2">Editar</a>                      
...
<a href="index.php" class="text-secondary custom-btn-link">Voltar à Página Inicial</a>
</p>
